...
var onGenerate = function() {
  ...
  htmlResult.innerHTML += '<p class="instructions">Copy and paste this here code:</p>';
  htmlResult.appendChild(embedTextArea).value = myCalendar.innerHTML;
  ...
  htmlResult.appendChild(embedTextArea).value += ('<style type="text/css">' + calendarCSS + '</style>');
